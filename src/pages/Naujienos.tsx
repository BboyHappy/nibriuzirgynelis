...
const Naujienos = () => {
  ...
  const articles = [
    ...
    {
      id: "stovykla-liepa-2026",
      title: "Praūžė dar viena stovykla!",
      date: "2026-07-08",
      image: "/lovable-uploads/nibriu-stovykla-2026-07.png",
      excerpt: "",
      content: "Prieš pat šitą liūtį užbaigėme dar vieną stovyklą. Šį kartą dalyvavo mažesni raiteliai su kuriais nuostabiai praleidome dvi dienas. Šaunuoliai mažieji, kurie išdrįso nakvoti ne namuose!",
      readTime: "2 dienų stovykla"
    },
    {
