...
import logoGreen from "@/assets/logo-horizontal.png";
...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white backdrop-blur-sm border-b border-border shadow-soft">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link to="/" className="flex items-center">
            <img src={logoGreen} alt="Nibrių Žirgynėlis" className="h-14 w-auto" />
          </Link>
